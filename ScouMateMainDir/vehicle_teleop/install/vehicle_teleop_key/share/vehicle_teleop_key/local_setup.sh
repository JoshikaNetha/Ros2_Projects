...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/vehicle_teleop_key"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vehicle_teleop_key/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vehicle_teleop_key/environment/path.sh"
